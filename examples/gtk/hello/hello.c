...
GVal on_activate_lam_0(GVal _0, GVal _1);
GVal on_activate(GVal _0);
GVal main_lam_0(GVal _0, GVal _1);
GVal glyph_main();
GVal on_activate__any_any_lam_0(GVal _0, GVal _1);
GVal on_activate__any_any(GVal _0);
GVal gtk_vbox__int_any(GVal _0);
GVal gtk_padded__any_int(GVal _0, GVal _1);
...
bb_0:
#ifdef GLYPH_DEBUG
  _glyph_null_check((GVal)_0, "field offset 1");
#endif
  _2 = ((GVal*)_0)[1];
  _3 = glyph_gtk_label_set_text(_2, (GVal)glyph_cstr_to_str((GVal)"Button clicked!"));
#ifdef GLYPH_DEBUG
  _glyph_call_depth--;
#endif
  return _3;
...
bb_0:
  ...
  _2 = _1;
  _3 = glyph_gtk_window_set_title(_2, (GVal)glyph_cstr_to_str((GVal)"Hello GTK from Glyph"));
  _4 = _3;
  _5 = glyph_gtk_window_set_size(_2, (GVal)400, (GVal)200);
  _6 = _5;
  _7 = gtk_vbox__int_any((GVal)10);
  _8 = _7;
  _9 = gtk_padded__any_int(_8, (GVal)20);
  _10 = _9;
  _11 = glyph_gtk_label_new((GVal)glyph_cstr_to_str((GVal)"Hello, World!"));
  _12 = _11;
  _13 = glyph_gtk_label_set_markup(_12, (GVal)glyph_cstr_to_str((GVal)"<big><b>Hello from Glyph!</b></big>"));
  _14 = _13;
  _15 = glyph_gtk_button_new((GVal)glyph_cstr_to_str((GVal)"Click me"));
  _16 = _15;
  { GVal* __c = (GVal*)glyph_alloc(16); __c[0] = (GVal)&on_activate_lam_0; __c[1] = (GVal)_12; _17 = (GVal)__c; }
  _18 = glyph_gtk_on_clicked(_16, _17);
  _19 = _18;
  _20 = glyph_gtk_box_append(_8, _12);
  _21 = _20;
  _22 = glyph_gtk_box_append(_8, _16);
  _23 = _22;
  _24 = glyph_gtk_window_set_child(_2, _8);
  _25 = _24;
...
GVal glyph_main() {
  ...
  GVal _5 = 0;
bb_0:
  _0 = glyph_gtk_app_new((GVal)glyph_cstr_to_str((GVal)"com.glyph.hello"));
  _1 = _0;
...
bb_0:
  ...
  _15 = glyph_gtk_button_new((GVal)glyph_cstr_to_str((GVal)"Click me"));
  _16 = _15;
  { GVal* __c = (GVal*)glyph_alloc(16); __c[0] = (GVal)&on_activate__any_any_lam_0; __c[1] = (GVal)_12; _17 = (GVal)__c; }
  _18 = glyph_gtk_on_clicked(_16, _17);
  _19 = _18;
  _20 = glyph_gtk_box_append(_8, _12);
  _21 = _20;
...
GVal gtk_vbox__int_any(GVal _0) {
  _glyph_current_fn = "gtk_vbox__int_any";
#ifdef GLYPH_DEBUG
  if (_glyph_call_depth < 256) _glyph_call_stack[_glyph_call_depth] = "gtk_vbox__int_any";
  _glyph_call_depth++;
#endif
  GVal _1 = 0;
  GVal _2 = 0;
...
GVal gtk_padded__any_int(GVal _0, GVal _1) {
  _glyph_current_fn = "gtk_padded__any_int";
#ifdef GLYPH_DEBUG
  if (_glyph_call_depth < 256) _glyph_call_stack[_glyph_call_depth] = "gtk_padded__any_int";
  _glyph_call_depth++;
#endif
  GVal _2 = 0;
  GVal _3 = 0;
